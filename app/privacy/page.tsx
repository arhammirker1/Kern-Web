...
export const metadata = {
  title: 'Privacy Policy — Kobin',
  description: 'Privacy policy for Kobin, the agency operating system.',
        ...
        <div style={{
          ...
          <div style={{ fontSize: '15px', color: 'var(--ghost)', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            <section>
              ...
              <p>
                Kobin (kobin.team) is an agency operating system built for founders and small teams. We are the data controller for information collected through our website and product. You can reach us at <a href="mailto:support@kobin.team" style={{ color: 'var(--vi)', textDecoration: 'none' }}>support@kobin.team</a>.
              </p>
            </section>
            ...
            <section>
              ...
              <ul style={{ paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <li><strong style={{ color: 'var(--ink)' }}>Supabase</strong> — stores waitlist and newsletter data in a hosted PostgreSQL database.</li>
                ...
                <li><strong style={{ color: 'var(--ink)' }}>Google Tag Manager / Analytics</strong> — website analytics.</li>
            ...
            <section>
              ...
              <p>
                When you connect Google to your Kobin workspace, we request the <code style={{ background: 'var(--parch)', padding: '2px 6px', borderRadius: '4px', fontFamily: "'Geist Mono', monospace", fontSize: '13px' }}>drive.file</code> and <code style={{ background: 'var(--parch)', padding: '2px 6px', borderRadius: '4px', fontFamily: "'Geist Mono', monospace", fontSize: '13px' }}>calendar.events</code> scopes only. We never access files you did not create through Kobin, and we never read your existing calendar events. Your Google data stays in your Google account at all times.
              </p>
            </section>
